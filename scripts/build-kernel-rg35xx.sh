...
MUST_HAVE="SQUASHFS SQUASHFS_ZLIB OVERLAY_FS BTRFS_FS EXT4_FS VFAT_FS
           ...
           SATA_AHCI
           BPF_SYSCALL CGROUP_BPF MEMCG BLK_CGROUP IPV6 FUSE_FS
           NF_CONNTRACK NFT_MASQ USB_MUSB_SUNXI PHY_SUN4I_USB
           USB_EHCI_HCD_PLATFORM RFKILL EFI_PARTITION CFG80211_WEXT"
missing=""
...
MUST_NOT_HAVE="ARCH_MEDIATEK ARCH_TEGRA ARCH_QCOM ARCH_ROCKCHIP ARCH_MESON
               ...
               ACPI EFI NUMA HIBERNATION KEXEC AUDIT ARM_SMMU_V3 VFIO
               MD BLK_DEV_DM SCSI_UFSHCD MMC_SDHCI BLK_DEV_NVME
               USB_DWC3 USB_DWC2 USB_CHIPIDEA TYPEC USB_CONFIGFS
               DRM_PANEL_SIMPLE DRM_PANEL_EDP DRM_SIMPLE_BRIDGE
               DRM_PANTHOR DRM_POWERVR DRM_I2C_ADV7511
               NET_SCHED NET_DSA IP_VS IP_PNP RC_CORE
               CHROME_PLATFORMS GREYBUS SPMI PCI_ENDPOINT PCI_IOV"
unpruned=""
