...
systemctl enable town-os-make-storage.service town-os-systemcontroller.service town-os-ui.service avahi-daemon.service systemd-networkd systemd-networkd-wait-online systemd-resolved
